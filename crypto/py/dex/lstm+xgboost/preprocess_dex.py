...
# load the dataset
df = pd.read_csv("dex_volume_data.csv")
...
# daily difference and volatility
...
# is holiday flag
holiday_list = ['2021-01-01', '2021-12-25', '2022-01-01', '2022-12-25', '2023-01-01', '2023-12-25', '2024-01-01', '2024-12-25', '2025-01-01']
...
look_back = 120   # past days used as input
...
def create_sequences(data, look_back, n_future):
    ...
    for i in range(len(data) - look_back - n_future + 1):
        ...
        # predict only the 'volume' feature (index 0) for the next n_future days
...
df.to_csv("dex_volume_preprocessed.csv", index=False)
